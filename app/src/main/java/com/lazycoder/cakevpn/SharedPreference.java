...
public class SharedPreference {
    ...
    public Server getServer() {
        ...
        Server server = new Server(mPreference.getString(SERVER_COUNTRY, "Netherlands"),
               mPreference.getString(SERVER_FLAG, getImgURL(R.drawable.nederlands)),
                        mPreference.getString(SERVER_OVPN, "nlo-1.opensvr.net-udp-1194.ovpn"),
                        mPreference.getString(SERVER_OVPN_USER, "opentunnel.net-restartdmg"),
                        mPreference.getString(SERVER_OVPN_PASSWORD, "andrewrestart46"));
